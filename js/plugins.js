...
$(function () {
    ...
    var scrollBox = $(".full-page > .overlay-container"),
        ...
        demo2Check = $(".resume-demo2").length,
     ...
     **====================== **/
    $(".kayo-work").typed({
        strings: ["Undergraduate.","Web Developer.", "Tech Enthusiast.", "Blogger.", "UI Designer."],
        cursorChar: "",
        typeSpeed: 150,
        loop: true,
        backSpeed: 50
    ...
    $(".resume-demo2-menu-toggle").on("click", function () {
        $(".resume-navbar").toggleClass('resume-demo2-mobile-menu-active');
    });
    /** => End Mobile Menu */
    ...
    $('.resume-demo2-clients-slider').slick({
        slidesToShow: 6,
        arrows: false,
        dots: false,
        responsive: [
